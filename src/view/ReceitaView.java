...
import dao.receita.ReceitaDAO;
import dao.receita.ReceitaImpl;
...
public class ReceitaView {
    public static void exibirMenu() {
        ReceitaDAO dao = new ReceitaImpl();
        ...
        while (true) {
            ...
            System.out.println("1. Registrar nova receita");
            ...
            switch (opcao) {
                case "1":
                    ...
                    CategoriaFinanceira categoria = categoriaFinanceiraDAO.getById(catId);
                    ParceiroNegocio parceiro = parceiroNegocioDAO.getById(parceiroId);
                    dao.insert(new Receita(0, valor, data, descricao, categoria, parceiro, status));
                    break;
                ...
                case "3":
                    ...
                    CategoriaFinanceira categoriaUpdate = categoriaFinanceiraDAO.getById(catId);
                    ParceiroNegocio parceiroUpdate = parceiroNegocioDAO.getById(parceiroId);

                    dao.update(new Receita(id, valor, data, descricao, categoriaUpdate, parceiroUpdate, status));
                    break;
                case "4":
                    System.out.print("ID: ");
